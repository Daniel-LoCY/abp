...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 312136fe-ef89-428c-ac00-4cbf64611ec8
```

> `312136fe-ef89-428c-ac00-4cbf64611ec8` is the password of the certificate, you can change it to any password you want.
